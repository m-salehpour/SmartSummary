...
class OllamaTranslator:
    ...
    async def _chat_stream_once(
        ...
        async with client.stream("POST", url, json=payload, timeout=self.cfg.timeout) as resp:
    ...
    async def translate_text(
        ...
        """
        chunks = chunk_text(text, max_out_tokens=max_out_tokens, max_in_tokens=max_in_tokens)
...
if __name__ == "__main__":
    ...
    from tools.translate_helpers import read_asr_json_text_and_lang, translate_asr_json_to_docx_sync

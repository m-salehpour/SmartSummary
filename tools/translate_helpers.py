...
import asyncio
from typing import AsyncIterator, Callable, Union, Any, Optional
...
async def translate_asr_json_to_docx(
    ...
    *,
    ...
    if translator is None:
        raise ValueError("translator callable is required (e.g., translate_he_or_fa_to_en_streaming)")
...
def translate_asr_json_to_docx_sync(
    ...
    *,
    ...
    """
    return asyncio.run(translate_asr_json_to_docx(json_path, out_docx, translator=translator))

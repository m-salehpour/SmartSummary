...
from src.persian_normalize.context_aware_normalizer.normalise_segments import \
    SegmentCleaner
from src.persian_normalize.context_aware_normalizer.summarise import \
    get_summary
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("usage:  python pipeline_clean.py in.json out.json")
        sys.exit(1)
    t0 = time.time()

...
def remap_hyp_keys(
    hyp_stats: Dict[str, float], mapping_hyp_to_ref: Dict[str, str]
) -> Dict[str, float]:
    """
...
def merge_ref_hyp_series(
    ref: Dict[str, float], hyp_mapped: Dict[str, float]
...
def plot_wer_by_speaker(
    wer_by_ref_speaker: Dict[str, float], title: str = "WER by reference speaker"
):
    """

...
RE_TOKEN = re.compile(
    rf"[{_PERSIAN_LETTERS}]+|[A-Za-z]+|\d+|[^\s{_PERSIAN_LETTERS}]+", re.UNICODE
)
...
def correct_fa_line_compound(
    text: str, sym: SymSpell, max_edit_distance: int = 2
) -> str:
...
def correct_fa_line_safer_blockwise(
    text: str, sym, lm=None, max_edit_distance=1, min_freq=10, min_gain_per_100=0.8
):
    out = []

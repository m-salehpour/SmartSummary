...
class SpacyDependencyParser(MaltParser):
    ...
    def _setup_model(self: "SpacyDependencyParser"):
        ...
        try:
            ...
            raise ValueError(
                "Something wrong loading the dependencyParser . Checkout for correctness or existence of path"
            )
    ...
    def parse_tagged_sents(
        ...
        return (DependencyGraph(item) for item in conll_list if item.strip())
